...
CREATE TABLE IF NOT EXISTS `order` (
                                       ...
                                       CONSTRAINT `CC2` CHECK ((`payment_status` in (_utf8mb4'Paid',_utf8mb4'Pending',_utf8mb4'Refunded'))),
                                       CONSTRAINT `CC3` CHECK ((`order_status` in (_utf8mb4'Shipped',_utf8mb4'Processing',_utf8mb4'Delivered',_utf8mb4'Cancelled')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
